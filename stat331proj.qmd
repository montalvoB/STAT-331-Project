...
The linear model with the transformation is: $$ \hat{y} = 23.24 + 18.62\ln(x_i),$$ {#eq-ln} where $\hat{y}$ is the estimated happiness score out of 100 and $x_i$ is a country's average daily income in 2017 purchasing power parity (PPP) dollars. 
