...
The following plot displays how the trend between the log of average daily income and happiness score per country changes over the years 2005-2023.
...
According to Figure 2, the positive relationship between the log of average daily income and happiness score remains relatively consistent from 2005-2023.
...
The R-squared value of 0.658 indicates that approximately 65.8% of the variability in county's happiness scores is explained by the regression model containing log of average daily income. This suggests a moderately strong fit, indicating that income is a meaningful factor in predicting national happiness.
