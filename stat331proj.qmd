...
For preliminary analysis, the following scatterplot (Figure 1) shows the relationship between average daily income and happiness score. Each point represents a country's averages of happiness score and average daily income across all years. 
...
```{r}
#| fig-cap: "Figure 3: Animated - Relationship Between Happiness Score and Avg Daily Income Over Time"
...
According to Figure 3, the positive relationship between the log of average daily income and happiness score remains relatively consistent throughout 2005 to 2023.
...
The linear model with the transformation is: $$ \hat{y} = 38.24 + 18.62\ln(x_i),$$ {#eq-ln} where $\hat{y}$ is the estimated happiness score out of 100 and $x_i$ is a country's average daily income in 2017 purchasing power parity (PPP) dollars. 
